...
class IconPharao extends PIXI.Sprite {
    backgroundRectangle = new PIXI.Rectangle(223 * 9, 0, 223, 223);
    frontRectangle = new PIXI.Rectangle(223 * 11, 0, 223, 223);
    headRectangle = new PIXI.Rectangle(223 * 10, 0, 223, 223);
