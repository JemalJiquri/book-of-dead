...
class IconMan extends PIXI.Sprite {
    backgroundRectangle = new PIXI.Rectangle(3 * 223, 0, 223, 223);
    frontRectangle = new PIXI.Rectangle(4 * 223, 0, 223, 223);
    headRectangle = new PIXI.Rectangle(5 * 223, 0, 223, 223);
